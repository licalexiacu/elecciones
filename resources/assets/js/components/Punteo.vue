<template>
    <main class="c-main" style="background-image: url('assets/img/Fondo_Formularios.jpg');">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><b>Punteo Electoral</b></li>
            </ol>
            <!-- GRILLA Y BUSCADOR -->
                ...
                <div class="modal-dialog" role="document" style="max-width: 95%; top: 25px;">
                    <div class="modal-content border-0 shadow-lg">
                        ...
                        <div class="modal-footer">
                            <button type="button" v-if="tipoAccion==1" class="btn btn-success btn-lg shadow-sm px-5 font-weight-bold" @click="puntear()">
