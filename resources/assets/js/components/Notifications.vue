    ...
    export default {
        ...
        computed:{
            listar: function(){
                ...
                this.notifications = Object.values(this.notifications[0]);
                if (this.notifications == '') {
                    ...
                    if (this.arrayNotifications.length > 3) {
                        // Si el tamaño es > 3 Es cuando las notificaciones son obtenidas del mismo servidor
                        return Object.values(this.notifications[4]);
                    } else {
                        // Si el tamaño es > 3 Es cuando las notificaciones son obtenidas desdel el canal privado ()
                        return Object.values(this.notifications[0]);
                    }
                }
            }
        }
